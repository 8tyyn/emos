          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="feature-banner header-text">
                <div class="row">
                  <div class="col-lg-12">
                   <center> <h1 style="color: #0eaedb;">TOURNER DROITE</h1><br> </center>
                  </div>
                  <style>
                    .col-lg-8 {
                      margin: auto;
              ...
              <div class="col-lg-12">
                <div class="content">
                  <div class="row">
                    ...
                    <center>
                    <div class="col-lg-4">
                      <img src="assets/images/tourner.png" alt="" style="border-radius: 23px; margin-bottom: 30px;">
                    </div>
                  </center>
                    <div class="col-lg-12">
